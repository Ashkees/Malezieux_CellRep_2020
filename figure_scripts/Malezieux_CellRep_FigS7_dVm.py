# -*- coding: utf-8 -*-
"""
Created on Fri Jan 10 16:20:27 2020
...
# Figure S7
# Description: mechanisms of LIA depolarization: dVm vs Vm0
...
# make the scatter
#fig, ax = plt.subplots(1, 1, figsize=[1.75, 1.4])
...
#fig, ax = plt.subplots(1, 1, figsize=[1.15, 1.4], sharey=True)
# create a figure with axes of defined size
fig = plt.figure(figsize=[2, 2])
# The first items are for padding and the second items are for the axes.
# sizes are in inch.
...
ax.set_ylabel('Vm (mV)')
ax.set_title('Cell 23', loc='left', fontsize=8)
#fig.tight_layout()
